        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm"> <!-- quand la sidebar est réduit -->
                        <img src="{{ asset('backend/assets/images/sk.png') }}" alt="logo-sm-light" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('backend/assets/images/sk.png') }}" alt="logo-light" height="50">
                    </span>
                </a>
            </div>
